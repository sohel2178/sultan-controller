...
import { RangsAlertAPI } from "@/lib/api"; // make sure this exists
...
export default function AdminAlerts() {
  ...
  const fetchAlerts = async () => {
    ...
    try {
      const data = await RangsAlertAPI.fetchLastAlertsByIMEI(imei, 30);
      setAlerts(data);
    } catch (err) {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <Card>
        <CardHeader>
          <CardTitle>Rangs Platform Device Alerts</CardTitle>
        </CardHeader>
