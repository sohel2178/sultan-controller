  ...
  return (
    <div className="w-full h-full p-4">
      <Card className="w-full h-full flex flex-col items-center justify-center p-0 gap-0">
        <div className="w-full flex flex-col xl:flex-row gap-4 bg-linear-to-r from-amber-50 to-yellow-50 p-4 rounded-xl shadow-sm border border-yellow-100">
          ...
          <div className="flex flex-col justify-between gap-4 xl:w-125">
                  ...
                  <tbody>
                    {filteredPayments.map((p) => (
                      ...
                      >
                        ...
                        <td className="px-3 py-2 truncate max-w-55">
                          {p.customer_email}
                        </td>
